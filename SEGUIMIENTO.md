...
*Última actualización: 2026-08-27, **cola de micro-pasos**: rate limiting COMPLETO (`6df6c70`, 30 req/min/IP mutación + 600 GET, 429+Retry-After), **paginación server-side COMPLETA** (`e528101`), **F1-FAVICON COMPLETO** (`912676b`, cierra Fase 1) y **EXPORT CSV COMPLETO** (`993ab45`, /api/scans/{id}/export/csv + /api/pipelines/{id}/export/csv, una fila por finding con metadata del run, BOM UTF-8+CRLF, fila resumen si sin findings); siguiente logging estructurado; suite 204 tests en verde; ruff limpio.
