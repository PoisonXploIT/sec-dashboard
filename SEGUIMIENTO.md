...
*Última actualización: 2026-08-27, **cola de micro-pasos CERRADA**: rate limiting (`6df6c70`), paginación server-side (`e528101`), F1-FAVICON (`912676b`, cierra Fase 1), export CSV (`993ab45`) y **LOGGING ESTRUCTURADO** (`6e8e8c1`: `backend/applog.py`, RotatingFileHandler data/logs 5MBx3 + stdout, namespace sec_dashboard, LOG_LEVEL/LOG_DIR env, lifecycle scan/pipeline + M1 traceback vía _log.exception); siguiente backlog OSINT (wayback_urls primero); suite 212 tests en verde; ruff limpio.
