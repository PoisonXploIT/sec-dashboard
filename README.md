...
| 🛡️ CSP Analyzer | Content Security Policy strength analysis |
| ↩️ Open Redirect | Open redirect vulnerability detection |
...
| ⚙️ Process Monitor | Running processes with network correlation |
